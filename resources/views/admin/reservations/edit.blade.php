            ...
            <div class="page-title">
                <div class="card card-absolute mt-5 mt-md-4">
                    <div class="card-header bg-primary">
                        <h5 class="text-white">🍕Editar reservas</h5>
                    </div>
                    <div class="card-body">
                        <p>
                            A continuación se muestra una página para editar una reserva. <span class="d-none d-md-inline">
                            </span>
                        </p>
                    </div>
                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="name">Telefono: <span class="text-danger">*</span></label>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon1">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="nomor_telepon_input" class="form-label">El número de invitados</label>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon1">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="nomor_telepon_input" class="form-label">Fecha
                                                Reserva</label>
                                        ...
                                        <div class="form-group col-md-12">
                                            <label for="juimagedul">Mesa: <span class="text-danger">*</span></label>
                                            <div class="mt-1">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="{{ route('admin.tables.index') }}"
                    class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Index mesa</a>
            </div>
            <div class="m-2 p-2 bg-slate-100 rounded">
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.reservations.update', $reservation->id) }}">
                        ...
                        <div class="sm:col-span-6">
                            <label for="tel_number" class="block text-sm font-medium text-gray-700"> Telefono
                            </label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6">
                            <label for="res_date" class="block text-sm font-medium text-gray-700"> Reserva
                            </label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6">
                            <label for="guest_number" class="block text-sm font-medium text-gray-700"> Telefono
                            </label>
                            <div class="mt-1">
