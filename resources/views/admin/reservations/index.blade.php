        ...
        <div class="page-title">
            <div class="card card-absolute mt-5 mt-md-4">
                <div class="card-header bg-primary">
                    <h5 class="text-white">📅 • Datos de reserva</h5>
                </div>
                <div class="card-body">
                    <p>
                        A continuación se muestra los datos de las reservas que se han creado. <span
                            class="d-none d-md-inline">
                            Las reservas se pueden editar presionando el icono del lápiz
                            y eliminar presionando el icono de la papelera.
                            <a href="{{ url('/admin/reservations/create') }}">Siguiente ⇾</a>
                        </span>
                    </p>
                </div>
            </div>
