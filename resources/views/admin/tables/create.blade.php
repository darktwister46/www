            ...
            <div class="page-title">
                <div class="card card-absolute mt-5 mt-md-4">
                    <div class="card-header bg-primary">
                        <h5 class="text-white">🪑 • Agrega una nueva mesa</h5>
                    </div>
                    <div class="card-body">
                        <p>
                            A continuación se muestra una página para agregar una mesa. <span class="d-none d-md-inline">
                            </span>
                        </p>
                    </div>
                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="name">Nombre de la mesa: <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="name">Sillas: <span class="text-danger">*</span></label>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon1">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="juimagedul">Posición de la mesa: <span
