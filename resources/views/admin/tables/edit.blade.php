            ...
            <div class="page-title">
                <div class="card card-absolute mt-5 mt-md-4">
                    <div class="card-header bg-primary">
                        <h5 class="text-white">🪑 • Editar Mesa</h5>
                    </div>
                    <div class="card-body">
                        <p>
                            A continuación se muestra una página para editar una mesa. <span class="d-none d-md-inline">
                            </span>
                        </p>
                    </div>
                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="name">Nombre mesa: <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="juimagedul">Posición mesa: <span
