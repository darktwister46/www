...
@section('title', 'Editar Menú - Admin')
@section('content')
            ...
            <div class="page-title">
                <div class="card card-absolute mt-5 mt-md-4">
                    <div class="card-header bg-primary">
                        <h5 class="text-white">🍕 • Editar menú </h5>
                    </div>
                    <div class="card-body">
                        <p>
                            A continuación se mostrará una página para editar el menú. <span class="d-none d-md-inline">
                                El menú que ha editado aparecerá en la página principal y en la página de "Menú"
                            </span>
                        </p>
                    </div>
                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="name">Nombre menú: <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="name">Precio: <span class="text-danger">*</span></label>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon1">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
