            ...
            <div class="page-title">
                <div class="card card-absolute mt-5 mt-md-4">
                    <div class="card-header bg-primary">
                        <h5 class="text-white">Agregar un nuevo menú</h5>
                    </div>
                    <div class="card-body">
                        <p>
                            A continuación se mostrará una página para agregar un menú. <span class="d-none d-md-inline">
                                El menú que ha agregado aparecerá en la página principal y en la página "Menús"
                            </span>
                        </p>
                    </div>
                </div>
