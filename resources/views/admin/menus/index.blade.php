        ...
        <div class="page-title">
            <div class="card card-absolute mt-5 mt-md-4">
                <div class="card-header bg-primary">
                    <h5 class="text-white">🍔 • Catálogo de menús</h5>
                </div>
                <div class="card-body">
                    <p>
                        A continuación se mostraran los datos del menú de alimentos y bebidas que ha realizado. <span
                            class="d-none d-md-inline">
                            También puede editar el menu pulsando el icono de lápiz o eliminarlo pulsando el icono de la papelera.
                            <a href="{{ url('/admin/menus/create') }}">Ir aquí ⇾</a>
                        </span>
                    </p>
                </div>
            </div>
                                ...
                                <tbody>
                                    @forelse ($menus as $item)
                                        <tr>
                                            ...
                                            <td>{{ substr(strip_tags(htmlspecialchars_decode($item->price)), 0, 60) }}€
                                            </td>
                                            <td>
